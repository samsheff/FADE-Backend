...
export enum SignalType {
  ...
  // ETF Arbitrage Breakdown signals
  ETF_ARB_STRESS_PERSISTENT_DISCOUNT = 'ETF_ARB_STRESS_PERSISTENT_DISCOUNT',
  ETF_ARB_STRESS_PERSISTENT_PREMIUM = 'ETF_ARB_STRESS_PERSISTENT_PREMIUM',
  ETF_ARB_STRESS_EXTREME_DEVIATION = 'ETF_ARB_STRESS_EXTREME_DEVIATION',
  ETF_ARB_IMPAIRED_ARBITRAGE_CHANNEL = 'ETF_ARB_IMPAIRED_ARBITRAGE_CHANNEL',

  // ETF AP Fragility signals
  ETF_AP_CONCENTRATION_HIGH = 'ETF_AP_CONCENTRATION_HIGH',
  ETF_AP_COUNT_DECLINING = 'ETF_AP_COUNT_DECLINING',
  ETF_CREATION_REDEMPTION_ONE_WAY_BURST = 'ETF_CREATION_REDEMPTION_ONE_WAY_BURST',

  // ETF Liquidity Mismatch signals
  ETF_LIQUIDITY_MISMATCH_ELEVATED = 'ETF_LIQUIDITY_MISMATCH_ELEVATED',
  ETF_FLOW_SHOCK_ILLIQUID_RISK = 'ETF_FLOW_SHOCK_ILLIQUID_RISK',
  ETF_TRACKING_STRESS = 'ETF_TRACKING_STRESS',

  // ETF Microstructure signals
  ETF_MICROSTRUCTURE_SPREAD_REGIME_SHIFT = 'ETF_MICROSTRUCTURE_SPREAD_REGIME_SHIFT',
  ETF_MICROSTRUCTURE_VOL_REGIME_SHIFT = 'ETF_MICROSTRUCTURE_VOL_REGIME_SHIFT',
  ETF_IMPACT_ASYMMETRY_WARNING = 'ETF_IMPACT_ASYMMETRY_WARNING',

  // ETF Disclosure Drift signals
  ETF_DISCLOSURE_REPEATED_PREM_DISC_EPISODES = 'ETF_DISCLOSURE_REPEATED_PREM_DISC_EPISODES',
  ETF_STRATEGY_DRIFT_INDICATOR = 'ETF_STRATEGY_DRIFT_INDICATOR',
  ETF_BASKET_POLICY_CHANGE_SIGNAL = 'ETF_BASKET_POLICY_CHANGE_SIGNAL',
}
